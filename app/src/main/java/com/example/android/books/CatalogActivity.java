...
public class CatalogActivity extends AppCompatActivity implements
    ...
    private void insertBook() {
        ...
        values.put(BookEntry.COLUMN_BOOK_NAME, "Wizard of Oz");
        values.put(BookEntry.COLUMN_BOOK_PRICE, 14);
        values.put(BookEntry.COLUMN_BOOK_QUANTITY, 1);
        values.put(BookEntry.COLUMN_BOOK_SUPPLIER, "John Doe");
        values.put(BookEntry.COLUMN_SUPPLIER_NUMBER, "132649");
